        ...
        <div className={styles.box}>
          ...
          <div className={styles.right_section_indexing}>
            ...
            <div className={styles.symbol}>
              ...
              <p>House No. 65A, Bagh Dilkusha, Bhopal (462023), Madhya Pradesh</p>
            </div>
            ...
            <div className={styles.follow_me_section}>
              ...
              <div className={styles.account_box}>
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.linkedin.com/in/arman-ali24/"
                    target="_blank"
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://github.com/arman-ali24"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.instagram.com/arman_since2005/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
